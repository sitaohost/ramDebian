...
#define TDX_HYPERCALL_r8 0 /* offsetof(struct tdx_hypercall_args, r8) */
#define TDX_HYPERCALL_r9 8 /* offsetof(struct tdx_hypercall_args, r9) */
#define TDX_HYPERCALL_r10 16 /* offsetof(struct tdx_hypercall_args, r10) */
#define TDX_HYPERCALL_r11 24 /* offsetof(struct tdx_hypercall_args, r11) */
#define TDX_HYPERCALL_r12 32 /* offsetof(struct tdx_hypercall_args, r12) */
#define TDX_HYPERCALL_r13 40 /* offsetof(struct tdx_hypercall_args, r13) */
#define TDX_HYPERCALL_r14 48 /* offsetof(struct tdx_hypercall_args, r14) */
#define TDX_HYPERCALL_r15 56 /* offsetof(struct tdx_hypercall_args, r15) */
#define TDX_HYPERCALL_rdi 64 /* offsetof(struct tdx_hypercall_args, rdi) */
#define TDX_HYPERCALL_rsi 72 /* offsetof(struct tdx_hypercall_args, rsi) */
#define TDX_HYPERCALL_rbx 80 /* offsetof(struct tdx_hypercall_args, rbx) */
#define TDX_HYPERCALL_rdx 88 /* offsetof(struct tdx_hypercall_args, rdx) */

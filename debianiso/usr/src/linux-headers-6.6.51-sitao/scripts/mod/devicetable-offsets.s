...
# -Wframe-larger-than=2048 -Wno-main -Wunused-const-variable=0 -Wvla
...
# -std=gnu11 -fmacro-prefix-map=./= -fshort-wchar -funsigned-char
...
# -falign-functions=16 -fno-strict-overflow -fstack-check=no
...
# 0 "" 2
# scripts/mod/devicetable-offsets.c:265: 	DEVID(cdx_device_id);
# 265 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->SIZE_cdx_device_id $8 sizeof(struct cdx_device_id)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:266: 	DEVID_FIELD(cdx_device_id, vendor);
# 266 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_cdx_device_id_vendor $0 offsetof(struct cdx_device_id, vendor)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:267: 	DEVID_FIELD(cdx_device_id, device);
# 267 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_cdx_device_id_device $2 offsetof(struct cdx_device_id, device)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:268: 	DEVID_FIELD(cdx_device_id, override_only);
# 268 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_cdx_device_id_override_only $4 offsetof(struct cdx_device_id, override_only)"	#
# 0 "" 2
# scripts/mod/devicetable-offsets.c:271: }
#NO_APP
	xorl	%eax, %eax	#
